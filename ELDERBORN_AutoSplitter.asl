...
state("Elderborn")
{
	byte loading : "UnityPlayer.dll", 0x144ED28, 0x40, 0xE0, 0x0, 0x18, 0x0, 0x0, 0x1108;
	...
	byte feverUsed : "UnityPlayer.dll", 0x13B6330, 0x80, 0x580, 0x170, 0x98, 0x40, 0x80, 0x40, 0xBD;
